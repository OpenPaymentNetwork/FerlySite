...
def upgrade():
    ...
    sa.Column('deviceToken', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_device_deviceToken'), 'device', ['deviceToken'], unique=True)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_device_deviceToken'), table_name='device')
